...
# Домашнее задание 
    # Задачи по git 
        ...
        # done      Создать ветку от мастера 
        # done      Сделать коммит 
        # done      Запушить ветку в репозиторий гитхам
        # done      Сделать pull request 
        # done Добавить меня к коллаборации репозитория (Ник BanaKing)
